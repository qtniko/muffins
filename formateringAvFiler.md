## Info
1. Dette er en gjennomgang av hvordan man skal skrive inn data for ulike formler  
2. Dataene leses og tolkes automatisk av andre filer (om skrevet inn riktig)  
3. Man kan legge sammen flere formler under samme fil  
4. Hver fil som brukes må inkluderes i HTML filen  
5. Funksjoner trenger ikke være i samme fil, siden de er globale for HTML DOM, men der blir mer oversiktlig om de er  
6. Pytagoras' læresetning blir brukt som eksempel for å demonstrere hvordan dette burde gjøres  
7. Følg stegene nedenfor for å riktig skrive inn dataene
...
Om man skriver "<
var variabel-ID>" vil det referere til variablen og teksten som vises hentes fra tekst verdien til variablen i verditabellen til variabel nøkkelen (Den du skriver nå).
...
Dette punktet er kanske rett frem;
