...
- Enkeltlinjekommentar, innledet med dobbel skråstrek (//), går over én linje og dekker hele linjen
...
Bare lag deg selv en liste over variablene, det trenger ikke være kommentert i filen.  
Eks:
> h, k1, k2
...
Argumentene må inneholde alle de andre variablene som urtregningen skal bruke, gjerne oppgit i rekkefølge ettersom hvor de er plassert i listen du lagde deg selv med variabler for funksjonen.  
...
Det er noen av dataene du allerede har definert, og du bare må fylle rett inn:
...
Det er best å starte med variabler, siden de to andre bruker definerte variabler.  
...
Inne i objektet skrives de ulike variablene som nøkler, når dataen hentes blir nøkklene brukt for å vise til hvilken av verdiene som programmet prøver å finne.  
...
Det samme gjelder sub elementet om den skal brukes.
...
Dette vil kalle funksjonen ved navn:
> rotnavn_variabel-ID
